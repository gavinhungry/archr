...
(function() {
  ...
  var SEARCH_URI = ARCH_URI + '/search/json/?arch=%s&q=%s'; // &repo=
   ...
   */
  archur.package = function(pkgname, repo, arch) {
   ...
   */
  archur.download = function(pkgname, repo, arch) {
    return archur.package(pkgname, repo, arch).then(archur.uri);
  };
